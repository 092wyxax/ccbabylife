...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/inbox', label: 'LINE 收件匣', roles: ['owner', 'manager', 'ops'] },
      { href: '/admin/returns', label: '退換貨', roles: ['owner', 'manager', 'ops'] },
      { href: '/admin/invoices', label: '電子發票', roles: ['owner', 'manager', 'ops'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/settings/ai', label: 'AI 設定', roles: ['owner', 'manager'] },
