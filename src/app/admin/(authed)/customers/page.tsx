  ...
  return (
    <div className="p-8 max-w-7xl">
      <header className="mb-6">
        ...
        <p className="text-ink-soft text-sm">共 {result.total} 位</p>
      </header>
        ...
        <>
          <div className="bg-white border border-line rounded-lg overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {result.rows.map(({ customer, orderCount, totalSpent }) => {
                  ...
                  return (
                    <tr key={customer.id} className="border-t border-line hover:bg-cream-50">
                      ...
                      <td className="px-4 py-3 text-right font-medium">{formatTwd(totalSpent)}</td>
