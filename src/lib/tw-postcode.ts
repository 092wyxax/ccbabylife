/**
 * Subset of Taiwan postcode data — city → districts with 3-digit zips.
 * Source: Chunghwa Post 3-digit zone codes (郵遞區號).
 * Trimmed to mainland TW + Penghu/Kinmen/Matsu.
 */
...
export const TW_POSTCODE: Record<string, DistrictEntry[]> = {
  台北市: [
...
export const TW_CITIES = Object.keys(TW_POSTCODE)
